...
import { Calendar as CalendarIconLucide, BarChart2, Filter, Search } from 'lucide-react'; // Renamed Calendar to avoid conflict
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
        <h1 className="text-3xl font-bold tracking-tight flex items-center"><CalendarIconLucide className="mr-3 h-8 w-8 text-primary" /> Student Timetable & Attendance</h1>
